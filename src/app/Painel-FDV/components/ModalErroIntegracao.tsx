  ...
  return (
    <div className={styles.modalOverlay} onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="modal-erro-integracao-title"
      >
        <div className={styles.modalHeader}>
          ...
          <div className={styles.headerText}>
            <h2 id="modal-erro-integracao-title" className={styles.modalTitle}>
              Erro na Integração
            </h2>
            {codPedido != null && (
              <p className={styles.modalSubtitle}>Pedido #{codPedido}</p>
            )}
          </div>
          <button
            type="button"
